...
<td width="20%" valign="top"  >{{ $data['cno'] }}</td>
...
<td valign="top"  >&nbsp;</td>
<td width="25%" valign="top"  >{{ substr((string) $data['client_code'], 0, 18) }}</td>
</tr>
<tr>
<td height="53" valign="bottom"  >&nbsp;</td>
<td width="25%" valign="top"  >{{ $data['size_type'] }} - {{ $data['iso'] }}</td>
<td valign="top"  >&nbsp;</td>
<td width="25%" valign="top"  >{{ $data['gate_status'] == 'IN' ? substr((string) $data['ex_consignee'], 0, 18) : substr((string) $data['shipper'], 0, 18) }}</td>
</tr>
<tr>
...
<tr>
<td height="53" valign="bottom"  >&nbsp;</td>
<td width="25%" valign="top" align="right">{{ $data['gate_status'] }} CHECKER {{ $data['origin'] }}</td>
<td valign="top"  >&nbsp;</td>
...
<tr>
<td height="53" valign="bottom" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $data['haud'] }}/{{ $data['lno'] }}</td>
<td width="25%" valign="top"  ></td>
<td valign="top"  >&nbsp;</td>
<td width="25%" valign="bottom" align="right">{{ $data['fn'] }}</td>
</tr>
</table></td>
</tr>
<tr></tr>
